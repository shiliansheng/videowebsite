...
CREATE TABLE `vw_video` (
    ...
    typename        varchar(32) NOT NULL                            COMMENT '视频类型名称',
...
INSERT INTO `vw_video`(videoname, typename, videoresource, username) VALUES('test video', '剧情', 'static/store/video/testvideo.mp4', 'admin');
INSERT INTO `vw_video`(videoname, typename, videoresource, username) VALUES('test video', '剧情', 'static/store/video/testvideo.mp4', 'admin');
INSERT INTO `vw_video`(videoname, typename, videoresource, username) VALUES('test video', '剧情', 'static/store/video/testvideo.mp4', 'admin');
INSERT INTO `vw_video`(videoname, typename, videoresource, username) VALUES('test video', '剧情', 'static/store/video/testvideo.mp4', 'admin');
INSERT INTO `vw_video`(videoname, typename, videoresource, username) VALUES('test video', '剧情', 'static/store/video/testvideo.mp4', 'admin');
