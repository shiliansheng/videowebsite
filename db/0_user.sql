...
CREATE TABLE `vw_user` (
  ...
  `username`      varchar(128)      NOT NULL UNIQUE DEFAULT ''    COMMENT '用户名',
  `password`      varchar(128)      NOT NULL DEFAULT ''           COMMENT '密码',
  `nickname`      varchar(128)      NOT NULL DEFAULT 'stranger'   COMMENT '昵称',
  `userlogo`      varchar(256)      DEFAULT NULL                  COMMENT '用户头像',
  `sex`           varchar(8)        DEFAULT '保密'                COMMENT '性别',
  `email`         varchar(128)      DEFAULT NULL                  COMMENT '电子邮箱',
  `birthday`      varchar(20)       DEFAULT NULL                  COMMENT '用户生日',
  `introduction`  varchar(512)      DEFAULT NULL                  COMMENT '简介',
  `status`        varchar(32)       NOT NULL DEFAULT '普通用户'    COMMENT '用户身份(普通用户,管理员)',
