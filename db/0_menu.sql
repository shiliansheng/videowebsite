...
INSERT INTO vw_system_menu(id, pid, title, icon, href) VALUES(130, "1", "用户管理", "fa fa-file-text", "");
INSERT INTO vw_system_menu(id, pid, title, icon, href) VALUES(140, "1", "视频管理", "fa fa-file-text", "");
INSERT INTO vw_system_menu(id, pid, title, icon, href) VALUES(131, "130", "用户列表", "fa fa-list-alt", "userlist.html");
